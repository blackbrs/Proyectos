...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Registro de Nueva Actividad</div>
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="porcentaje" type="number" class="form-control @error('porcentaje') is-invalid @enderror" name="porcentaje" value="{{ old('porcentaje') }}" required autocomplete="porcentaje" autofocus>
